...
class Sqldb_Musicsite:
    ...
    def start_dialog(self):
        while True:
            ...
            if qst.lower() == 'y':
                Sqldb_Musicsite.db_user_create(Sqldb_Musicsite(data_base='sql_db_250522', user='user_250522'))
                break
            elif qst.lower() == 'n':
                print('Good by!')
                break
    ...
    def db_user_create(self):
        pswd = Sqldb_Musicsite.sql_psw(Sqldb_Musicsite(data_base='sql_db_250522', user='user_250522'))
        ...
        while True:
            ...
            if qst.lower() == 'y':
                Sqldb_Musicsite.create_tables(Sqldb_Musicsite(data_base='sql_db_250522', user='user_250522'))
                break
            elif qst.lower() == 'n':
                print('Good by!')
                break
    ...
    def create_tables(self):
        ...
        while True:
            ...
            if qst.lower() == 'y':
                Sqldb_Musicsite.insert_tabvalues(Sqldb_Musicsite(data_base='sql_db_250522', user='user_250522'))
                break
            elif qst.lower() == 'n':
                print('Good by!')
                break
    ...
    def insert_tabvalues(self):
        ...
        req = ''
        count = 0
        with open('Script_Insert_SQL_250522.sql', 'r') as file:
        ...
        while True:
            ...
            if qst.lower() == 'y':
                Sqldb_Musicsite.select_tabdata(Sqldb_Musicsite(data_base='sql_db_250522', user='user_250522'))
                break
            elif qst.lower() == 'n':
                print('Good by!')
                break
